...
export const useDashboardData = (
  userRole: UserRole,
  selectedFilter: string = "12months"
) => {
  ...
  const { data: roleDistribution, isLoading: isLoadingRoles } = useQuery<
    ...
    ApiResponseError
  >({
    queryKey: ["role-distribution", userRole, selectedFilter],
    queryFn: async () =>
      await getRequest({
  ...
  const { data: weeklyActivities, isLoading: isLoadingActivities } = useQuery<
    ...
    ApiResponseError
  >({
    queryKey: ["weekly-activities", userRole, selectedFilter],
    queryFn: async () =>
      await getRequest({
  ...
  const { data: subDistribution, isLoading: isLoadingSubs } = useQuery<
    ...
    ApiResponseError
  >({
    queryKey: ["sub-distribution", userRole, selectedFilter],
    queryFn: async () =>
      await getRequest({
  ...
  const { data: companyStatus, isLoading: isLoadingStatus } = useQuery<
    ...
    ApiResponseError
  >({
    queryKey: ["company-status", userRole, selectedFilter],
    queryFn: async () =>
      await getRequest({
  ...
  const { data: moduleUsage, isLoading: isLoadingModules } = useQuery<
    ...
    ApiResponseError
  >({
    queryKey: ["module-usage", userRole, selectedFilter],
    queryFn: async () =>
      await getRequest({
  ...
  const { data: solicitationStatus, isLoading: isLoadingSolicitationStatus } =
    useQuery<ApiResponse<SolicitationStatusData>, ApiResponseError>({
      queryKey: ["solicitation-status", userRole, selectedFilter],
      queryFn: async () =>
        await getRequest({
  ...
  const { data: bidIntent, isLoading: isLoadingBidIntent } = useQuery<
    ...
    ApiResponseError
  >({
    queryKey: ["bid-intent", userRole, selectedFilter],
    queryFn: async () =>
      await getRequest({
  ...
  const { data: vendorsDistribution, isLoading: isLoadingVendorsDistribution } =
    useQuery<ApiResponse<VendorsDistributionData>, ApiResponseError>({
      queryKey: ["vendors-distribution", userRole, selectedFilter],
      queryFn: async () =>
        await getRequest({
  ...
  const { data: proposalSubmission, isLoading: isLoadingProposalSubmission } =
    useQuery<ApiResponse<any>, ApiResponseError>({
      queryKey: ["proposal-submission", userRole, selectedFilter],
      queryFn: async () =>
        await getRequest({
  ...
  const {
    ...
    queryKey: ["company-role-distribution", userRole, selectedFilter],
    queryFn: async () =>
      await getRequest({
  ...
  const { data: procurementSolicitationStatus, isLoading: isLoadingProcurementSolicitationStatus } =
    useQuery<ApiResponse<SolicitationStatusData>, ApiResponseError>({
      queryKey: ["procurement-solicitation-status", userRole, selectedFilter],
      queryFn: async () =>
        await getRequest({
          url: "/procurement/solicitations/analytics/status",
          config: {
  ...
  const { data: procurementBidIntent, isLoading: isLoadingProcurementBidIntent } = useQuery<
    ApiResponse<any>,
    ApiResponseError
  >({
    queryKey: ["procurement-bid-intent", userRole, selectedFilter],
    queryFn: async () =>
      await getRequest({
        url: "/procurement/solicitations/analytics/bid-intent",
        config: {
  ...
  const { data: procurementVendorsDistribution, isLoading: isLoadingProcurementVendorsDistribution } =
    useQuery<ApiResponse<VendorsDistributionData>, ApiResponseError>({
      queryKey: ["procurement-vendors-distribution", userRole, selectedFilter],
      queryFn: async () =>
        await getRequest({
          url: "/procurement/solicitations/analytics/vendors-distribution",
          config: {
  ...
  const { data: procurementProposalSubmission, isLoading: isLoadingProcurementProposalSubmission } =
    useQuery<ApiResponse<any>, ApiResponseError>({
      queryKey: ["procurement-proposal-submission", userRole, selectedFilter],
      queryFn: async () =>
        await getRequest({
          url: "/procurement/solicitations/analytics/proposal-submission",
          config: {
  ...
  const { data: procurementWeeklyActivities, isLoading: isLoadingProcurementWeeklyActivities } =
    useQuery<ApiResponse<any>, ApiResponseError>({
      queryKey: ["procurement-weekly-activities", userRole, selectedFilter],
      queryFn: async () =>
        await getRequest({
  ...
  const { data: procurementTotalEvaluations, isLoading: isLoadingProcurementTotalEvaluations } =
    useQuery<ApiResponse<any>, ApiResponseError>({
      queryKey: ["procurement-total-evaluations", userRole, selectedFilter],
      queryFn: async () =>
        await getRequest({
